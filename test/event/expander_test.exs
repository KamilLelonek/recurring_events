  ...
  test "should expand all Events" do
    ...
    assert [
      %Event.Repetition.Occurence{
        ...
        time_start:    %Ecto.Time{hour: 1, min: 0, sec: 0},
        time_end:      %Ecto.Time{hour: 2, min: 0, sec: 0},
      },
      %Event.Repetition.Occurence{
        event_id:      event.id,
        repetition_id: repetition_id,
        date:          %Ecto.Date{year: 2000, month: 01, day: 11},
        time_start:    %Ecto.Time{hour: 1, min: 0, sec: 0},
        time_end:      %Ecto.Time{hour: 2, min: 0, sec: 0},
      },
      %Event.Repetition.Occurence{
        event_id:      event.id,
        repetition_id: repetition_id,
        date:          %Ecto.Date{year: 2000, month: 01, day: 21},
        time_start:    %Ecto.Time{hour: 1, min: 0, sec: 0},
        time_end:      %Ecto.Time{hour: 2, min: 0, sec: 0},
      },
      %Event.Repetition.Occurence{
        event_id:      event.id,
        repetition_id: repetition_id,
        date:          %Ecto.Date{year: 2000, month: 01, day: 31},
        time_start:    %Ecto.Time{hour: 1, min: 0, sec: 0},
        time_end:      %Ecto.Time{hour: 2, min: 0, sec: 0},
      },
